...
const PageantShowdownWindow: React.FC<PageantShowdownWindowProps> = ({
    ...
    return (
        <div className="absolute inset-0 z-0 flex flex-col items-center justify-center text-white bg-gradient-to-b from-[#1a1030] via-[#120a24] to-[#0a0614] overflow-hidden">
            {!gameCompleted && (
            ...
            <div className="relative flex items-center justify-center gap-3 sm:gap-6 w-full h-full px-6 pt-16 pb-16">
                ...
                <AnimatePresence>
                    {gameCompleted && (
                        ...
                        >
                            <Image
                                src="/pageant-showdown/judge.png"
                                alt="The judge"
                                width={260}
                                height={260}
                                unoptimized
